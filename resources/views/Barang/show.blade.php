                ...
                <div class="product-detail-desc pd-20 card-box height-100-p">
                    <form>
                        ...
                        <div class="form-group row" style="padding-left: 40px">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="text" name="id_supplier" id="id_supplier" value="{{ $barang->supplier->nama_supplier}}" aria-describedby="id_supplier" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                    </form>
                </div>
