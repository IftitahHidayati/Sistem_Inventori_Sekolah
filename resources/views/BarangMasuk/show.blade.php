                    ...
                    <form>
                        <div class="form-group row" style="padding-left: 20px">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="text" name="kode_masuk" id="kode_masuk" value="{{ $masuk->kode_masuk }}" aria-describedby="kode_masuk" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                        <div class="form-group row" style="padding-left: 20px">
                            <label for="id_keluar" class="col-sm-10 col-md-4 col-form-label text-white">Kode Out</label>
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="text" name="id_keluar" id="id_keluar" value="{{ $masuk->BarangKeluar->kode }}" aria-describedby="id_keluar" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                        <div class="form-group row" style="padding-left: 20px">
                            <label for="id_barang" class="col-sm-10 col-md-4 col-form-label text-white">Nama Barang</label>
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="text" name="id_barang" id="id_barang" value="{{ $masuk->barang->nama_barang }}" aria-describedby="id_barang" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                        <div class="form-group row" style="padding-left: 20px">
                            <label for="id_barang" class="col-sm-10 col-md-4 col-form-label text-white">Kode Barang</label>
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="text" name="id_barang" id="id_barang" value="{{ $masuk->barang->kode_barang }}" aria-describedby="id_barang" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="product-detail-desc pd-20 card-box height-100-p">
                    <form>
                        <div class="form-group row" style="padding-left: 20px">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="text" name="id_keluar" id="id_keluar" value="{{ $masuk->BarangKeluar->penanggung_jawab }}" aria-describedby="id_keluar" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                        <div class="form-group row" style="padding-left: 20px">
                            <label for="id_keluar" class="col-sm-10 col-md-4 col-form-label text-white">Peminjam</label>
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="text" name="id_keluar" id="id_keluar" value="{{ $masuk->BarangKeluar->peminjam }}" aria-describedby="id_keluar" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                        <div class="form-group row" style="padding-left: 20px">
                        ...
                        <div class="form-group row" style="padding-left: 20px">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="date" name="id_keluar" id="id_keluar" value="{{ $masuk->BarangKeluar->tgl_keluar }}" aria-describedby="id_keluar" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                        <div class="form-group row" style="padding-left: 20px">
                            <label for="tgl_masuk" class="col-sm-10 col-md-4 col-form-label text-white">Tgl Masuk</label>
                            <div class="col-md-7 col-sm-12">
                                <input class="form-control" type="date" name="tgl_masuk" id="tgl_masuk" value="{{ $masuk->tgl_masuk }}" aria-describedby="tgl_masuk" placeholder="Disabled input" disabled="">
                            </div>
                        </div>
                    </form>
                </div>
