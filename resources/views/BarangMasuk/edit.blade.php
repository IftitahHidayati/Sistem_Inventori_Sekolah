...
<div class="pd-20 card-box mb-30">
    ...
    <form method="POST" action="{{ route('BarangMasuk.update', $masuk->kode_masuk) }}" id="myForm" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <label for="penerima" class="col-sm-12 col-md-2 col-form-label text-white">Penerima</label>
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="number" name="penerima" id="penerima" value="{{ $masuk->penerima }}" aria-describedby="penerima" placeholder="">
            </div>
        </div>
        <div class="form-group row">
