...
<div class="pd-20 card-box mb-30">
    ...
    <form method="POST" action="{{ route('BarangKeluar.update', $keluar->kode) }}" id="myForm" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <label for="peminjam" class="col-sm-12 col-md-2 col-form-label text-white">Peminjam</label>
            <div class="col-sm-12 col-md-10">
                <input class="form-control" type="text" name="peminjam" id="peminjam" value="{{ $keluar->peminjam }}" aria-describedby="peminjam" placeholder="">
            </div>
        </div>
        <div class="form-group row">
